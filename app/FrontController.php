...
class FrontController {
     ...
     * @var $_instance self is used in other controllers for the giving reference to the instance of this class
     */
    ...
    private function __construct() {
        ...
        $this->_controller = !empty($splits[0]) ? ucfirst($splits[0]) . 'Controller' : 'TaskController';
